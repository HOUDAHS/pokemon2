...
// Build an auto-complete widget using the following api endpoints:
// 1. fetch all pokemon: https://pokeapi.co/api/v2/pokemon?limit=150
// 2. fetch details for one pokemon: https://pokeapi.co/api/v2/pokemon/{pokemonName}
